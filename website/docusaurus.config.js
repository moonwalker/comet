...
const config = {
  title: 'Comet',
  tagline: 'Cosmic tool for provisioning and managing infrastructure.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://moonwalker.github.io',
  ...
  organizationName: 'moonwalker', // Usually your GitHub org/user name.
